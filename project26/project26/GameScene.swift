...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func loadLevel() {
        guard let levelURL = Bundle.main.url(forResource: "level1", withExtension: ".txt"),
              let levelString = try? String(contentsOf: levelURL) else {fatalError("file not found")}
    ...
    func createPlayer() {
        ...
        player.physicsBody?.contactTestBitMask = CollisionTypes.vortex.rawValue | CollisionTypes.star.rawValue | CollisionTypes.finish.rawValue
