...
//  project11
//
//  Created by Patrick on 21.06.2022..
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if object.contains(editLabel) {
            ...
            if editingMode {
                ...
                if ballCount > 0 {
                    let ballColor = randomBall(ballColor: Int.random(in: 1..<7))
    ...
    func randomBall(ballColor: Int) -> String {
        switch ballColor {
        case 1: return "ballBlue"
        case 2: return "ballCyan"
        case 3: return "ballGreen"
        case 4: return "ballGrey"
        case 5: return "ballPurple"
        case 6: return "ballYellow"
        default: return "ballRed"
        }
    }
}
