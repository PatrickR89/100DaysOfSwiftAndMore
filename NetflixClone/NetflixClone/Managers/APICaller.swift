...
struct Constants {
    static let API_KEY = "2302884f855e8145a3043aeeefbdcf78"
...
//                print(error)
    ...
    func getTopSearchedMovies(completion: @escaping (Result<[MediaObject], Error>) -> Void) {
    ...
    func searchMovies(with query: String, completion: @escaping (Result<[MediaObject], Error>) -> Void) {
